...
- `workflows/track_c_pipeline.md` explains the new sentiment-and-topic drift pipeline.
- `workflows/track_d_pipeline.md` explains the new cold-start recommender pipeline.
- `config/track_c_yaml.md` and `config/track_d_yaml.md` explain the new per-track settings.
- `code/track_c_modules.md` and `code/track_d_modules.md` explain the new stage modules in plain English.
...
- **Goal:** 5 research tracks exploring rating prediction, review usefulness, sentiment trends, recommendations, and fairness
